...
// Parent class of various classifiers
AbstractAdapter* classifier;
...
vector< pair<string, double> > SpecificClassifier::classify(Mat img, int resNum) {
            vector <complex <double> > gran_cof_img;
            vector <Point> contour;
            int index;
            vector< pair<string, double> > ret;
            ...
            string kl = classifier->classify(gran_cof_vect);
            gran_cof_vect.clear();
...
void SpecificClassifier::learn(map< string, vector<Mat> >& learningData, void* param) {
            Mat image;
            vector <Point> contour;
            vector <complex <double> > gran_cof_img;
            map <string, vector<Mat> >::iterator data;
            ...
            classifier = (AbstractAdapter*) param;
